...
class VideoRecorder(
    ...
    private var mediaPlayerStart : MediaPlayer? = MediaPlayer.create(activity,
        R.raw.recording_start
    )
    private var mediaPlayerStop : MediaPlayer? = MediaPlayer.create(activity,
        R.raw.recoding_stop
    )
    ...
    private fun startRecording(){
        try{
            ...
            Toast.makeText(activity,"Failed to create video",Toast.LENGTH_LONG).show()
        }
    ...
    private fun buildFile() : File?{
        ...
        val path =  Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_MOVIES)?.absolutePath + "/RealAR/${date}_video.mp4"
    ...
    private fun buildFileApi29(): FileDescriptor? {
        ...
        val contentValues = ContentValues().apply {
            ...
            put(MediaStore.MediaColumns.RELATIVE_PATH,"Movies/RealAR")
        }
